...
contract AAERC20Paymaster is IAccount, BasePaymaster, AAERC20 {
    ...
    IPaymasterOracle immutable oracle;
    IPaymasterSwap immutable swap;
    ...
    constructor(
        ...
        oracle = _oracle;
        swap = _swap;
        _oracle.enable(abi.encode(address(_token)));
        _swap.enable(abi.encode(address(_token)));
        ...
        returns (bytes memory context, uint256 validationData)
    {
        ...
        unchecked {
            ...
            uint256 feeAmount = (requiredPreFund + (REFUND_POSTOP_COST) * userOp.maxFeePerGas) * PRICE_MARKUP;
